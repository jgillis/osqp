...
# endif /* ifdef OSQP_ENABLE_PROFILING */
  ...
  // Store initial rho value for cold start restoration
  work->rho_initial = settings->rho;
...
#if OSQP_EMBEDDED_MODE != 1
  /* Restore initial rho value (handles both scalar and vectorized rho) */
  osqp_update_rho(solver, work->rho_initial);
#endif
}
